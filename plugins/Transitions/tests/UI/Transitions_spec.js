...
describe("Transitions", function () {
    ...
    it('should show report in reporting ui with data', async function () {
        await page.load("?" + urlBase + "#?" + generalParams + "&category=General_Actions&subcategory=Transitions_Transitions");
        await page.waitForNetworkIdle();
    ...
    it('should show report in widget ui in selector', async function () {
        await page.load("?module=Widgetize&action=iframe&widget=1&moduleToWidgetize=Transitions&actionToWidgetize=getTransitions&"+generalParams+"&disableLink=1&widget=1");
        await page.waitForNetworkIdle();
